...
public class Tugas2_04 {
    public static void main(String[] args) {
        ...
        System.out.println("+++++++++++++++++++++++++++++++++");
        System.out.println("--------- LOMBA PORSENI ---------");
        System.out.println("+++++++++++++++++++++++++++++++++");
        ...
        for (int i = 1; i <= jumlah_politeknik; i++) {
            ...
            for (int j = 1; j <= atlet; j++) {
                ...
                System.out.println("Politeknik ke-" + i + ", Cabang Badminton, Atlet " + j + ": " +
                        nama_atlet);
            }
            System.out.println();
            ...
            for (int j = 1; j <= atlet; j++) {
                System.out.print("Masukkan nama atlet " + j + ": ");
                String nama_atlet = input.nextLine();
                System.out.println("Politeknik ke-" + i + ", Cabang Tenis Meja, Atlet " + j + ": " +
                        nama_atlet);
            }
            System.out.println();
            ...
            for (int j = 1; j <= atlet; j++) {
                System.out.print("Masukkan nama atlet " + j + ": ");
                String nama_atlet = input.nextLine();
                System.out.println("Politeknik ke-" + i + ", Cabang Basket, Atlet " + j + ": " +
                        nama_atlet);
            }
            System.out.println();
            ...
            for (int j = 1; j <= atlet; j++) {
                System.out.print("Masukkan nama atlet " + j + ": ");
                String nama_atlet = input.nextLine();
                System.out.println("Politeknik ke-" + i + ", Cabang Bola Voli, Atlet " + j + ": " +
                        nama_atlet);
            }
            System.out.println();
        }
